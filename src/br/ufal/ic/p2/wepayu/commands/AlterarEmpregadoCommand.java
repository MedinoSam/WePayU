...
import br.ufal.ic.p2.wepayu.models.pagamento.*;
...
public class AlterarEmpregadoCommand implements Command {
        ...
        switch (atributo) {
            ...
            case "comissao":
                if (empregado instanceof EmpregadoComissionado) {
                    return ((EmpregadoComissionado) empregado).getTaxaDeComissao();
                }
                return null;
            case "sindicalizado":
        ...
        switch (atributo) {
            ...
            case "salario":
                ...
                if ("comissionado".equals(tipoAtualSalario)) {
                    double comissaoAtual = ((EmpregadoComissionado) empregado).getTaxaDeComissao();
            ...
            case "comissao":
                ...
                if (empregado instanceof EmpregadoComissionado) {
                    ...
                    ((EmpregadoComissionado) empregado).setTaxaDeComissao(comissaoNumerica);
                } else {
            ...
            case "sindicalizado":
                ...
                if (sindicalizado) {
                    ...
                    try {
                        ...
                        throw new ValorMonetarioInvalidoException("Taxa sindical deve ser numerica.");
                    }

                    if (taxa < 0) {
                        throw new ValorMonetarioInvalidoException("Taxa sindical deve ser nao-negativa.");
                    }
                    ...
                    if (idSindicato != null && taxaSindical != null) {
                        MembroSindicato membro = MembroSindicatoFactory.criarMembro(idSindicato, taxaSindical);
            ...
            case "metodoPagamento":
                ...
                if ("banco".equals(metodoValor)) {
                    ...
                    Banco metodoBanco = new Banco(banco, agencia, contaCorrente);
            ...
            case "agendaPagamento":
                ...
                if (!AgendaPagamento.isAgendaValida(valor)) {
    ...
    private void restaurarValorAnterior(Empregado empregado, String atributo, Object valorAnterior) {
        ...
        switch (atributo) {
            ...
            case "comissao":
                if (empregado instanceof EmpregadoComissionado) {
                    ((EmpregadoComissionado) empregado).setTaxaDeComissao((Double) valorAnterior);
                }
                break;
            case "sindicalizado":
            ...
            case "banco":
                if (empregado.getMetodoPagamento() instanceof Banco) {
                    ((Banco) empregado.getMetodoPagamento()).setBanco((String) valorAnterior);
                }
                break;
            case "agencia":
                if (empregado.getMetodoPagamento() instanceof Banco) {
                    ((Banco) empregado.getMetodoPagamento()).setAgencia((String) valorAnterior);
                }
                break;
            case "contaCorrente":
                if (empregado.getMetodoPagamento() instanceof Banco) {
                    ((Banco) empregado.getMetodoPagamento()).setContaCorrente((String) valorAnterior);
                }
                break;
            case "agendaPagamento":
                empregado.setAgendaPagamento((AgendaPagamento) valorAnterior);
                break;
        }
    }
}